...
\begin{figure}
  ...
  \begin{center}
    ...
    \epsfig{file=sphere.ps,width=.3\columnwidth}
    \epsfig{file=ds.ps,width=.3\columnwidth}
    \epsfig{file=larcyl.ps,width=.3\columnwidth}
...
\begin{figure}
  ...
  \begin{center}
    ...
    \epsfig{file=hv.ps,width=.5\columnwidth}
...
\begin{figure}[H]
  ...
  \begin{center}
    ...
    \epsfig{file=moab_rf.ps,width=0.9\columnwidth}
    \epsfig{file=embree_rf.ps,width=0.9\columnwidth}
