...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Fluka, FluGG adn FluDAG}
...
assinments that are then pasted into the input deck for the main
...
incrmental radius of the volume, i.e. 10.0 cm. Running the calculation
...
The variation bewteen Fluka and FluDAG results are no larger than the
