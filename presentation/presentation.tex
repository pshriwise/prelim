...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      %Surface A
      \node (t0) [mbelement, fill=red, above = 2cm of v0, xshift=-2cm] {\small t0};
      \node (t1) [mbelement, fill=red, above = 2cm of v1, right = 0cm of t0] {\small t1};
      \node (t2) [mbelement, fill=red, above = 2cm of v2, right = 0cm of t1] {\small t2};
      \node (t3) [mbelement, fill=red, above = 2cm of v3, right = 0cm of t2] {\small t3};
...
%      \node (t5) [mbelement, fill=red, above = 2cm of v5, xshift=-3cm] {\small t5};
      ...
      \node (surfA) [auto,above = 0.25cm of t1] {Surface A};


      %Surface B
      \node (t4) [mbelement, fill=red, above = 2cm of v0, right = 3cm of ellipses] {\small t4};
      \node (t5) [mbelement, fill=red, above = 2cm of v1, right = 0cm of t4] {\small t5};
      \node (t6) [mbelement, fill=red, above = 2cm of v2, right = 0cm of t5] {\small t6};
      \node (t6) [mbelement, fill=red, above = 2cm of v3, right = 0cm of t6] {\small t7};
%      \node (t4) [mbelement, fill=red, above = 2cm of v4, xshift=-3cm] {\small t4};
%      \node (t5) [mbelement, fill=red, above = 2cm of v5, xshift=-3cm] {\small t5};
      \node (ellipses) [auto,right = 0cm of t6] {...};
      \node (surfB) [auto,above = 0.25cm of t5] {Surface B};
      ...
      \draw [-,color=orange] (t5) -- (v3);
      \draw [-,color=orange] (t5) -- (v4);
      \draw [-,color=orange] (t5) -- (v5);
