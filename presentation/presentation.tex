...
\begin{tikzpicture}
  ...
  \pause
  \node (ds mesh) at (ds.north east) {\includegraphics[scale=0.05,xshift=0.5cm]{hv.png}};
  \pause
  \node (lar cyl mesh) at (larcyl.south west) {\includegraphics[scale=0.08,crop = 100 0 0 0 ]{lar_cyl_mesh.png}};
