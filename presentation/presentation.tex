...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      %Surface A
      \node (t0) [mbelement, fill=red, above = 2cm of v0, xshift=-3cm] {\small t0};
      \node (t1) [mbelement, fill=red, above = 2cm of v1, xshift=-3cm] {\small t1};
      \node (t2) [mbelement, fill=red, above = 2cm of v2, xshift=-3cm] {\small t2};
      \node (t3) [mbelement, fill=red, above = 2cm of v3, xshift=-3cm] {\small t3};
...
%      \node (t5) [mbelement, fill=red, above = 2cm of v5, xshift=-3cm] {\small t5};
      ...
      %Surface B
      \node (t4) [mbelement, fill=red, above = 2cm of v0, right = 4cm of ellipses] {\small t4};
