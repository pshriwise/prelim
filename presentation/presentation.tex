...
\begin{frame}
  ...
  Fortunately, we can maintain this \textit{topological} watertightness in our Embree representation of the mesh.
...
\begin{tikzpicture}
  ...
  \node (nc) [auto,right = of ns] {\includegraphics[scale=0.2]{nested_cubes.png}};
  \node (nsl) [auto,below = of ns] {Nested Spheres};
  \node [auto,right = of nsl,xshift=2cm] {Nested Cubes};
