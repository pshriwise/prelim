...
\begin{center}
  \begin{tikzpicture}
    ...
    \node (SHALLOW) [auto, outer sep=10pt, label=below:{\small shallow}] {\includegraphics[width=0.3\textwidth]{./images/sphere_obbs_shallow.png}};
    \node [myarrow,rotate=0,xshift=3.5cm] {};
    \node (DEEP) [auto, outer sep=10pt, xshift=7cm, label=below:{\small deep}] {\includegraphics[width=0.3\textwidth]{./images/sphere_obbs_deep.png}};
...
\end{itemize}
\includegraphics[scale=0.4, trim = 20 50 0 0]{./images/sealing_ex.png}
\end{frame}
...
\begin{tikzpicture}
  \node (sphere) {\includegraphics[scale=0.2]{../paper/figs/sphere.png}};
  \node (ds) [right =  of sphere] {\includegraphics[scale=0.2]{../paper/figs/ds.png}};
  \node (larcyl) [right =  of ds] {\includegraphics[scale=0.2]{../paper/figs/larcyl.png}};
  \pause 
  \node (sphere mesh) at (sphere.south east) [rotate=180,xshift=0.5cm] {\includegraphics[scale=0.08]{./images/sphere_mesh.png}};
  \pause
  \node (ds mesh) at (ds.north east) {\includegraphics[scale=0.1,xshift=0.5cm]{../paper/figs/hv.png}};
  \pause
  \node (lar cyl mesh) at (larcyl.south west) {\includegraphics[scale=0.08,crop = 100 0 0 0 ]{./images/lar_cyl_mesh.png}};
...
\begin{columns}
  ...
  \begin{figure}
    \centering
    \includegraphics[scale=0.3]{../paper/figs/moab_rf.png}
  \end{figure}
  \column{0.45\textwidth}
  \begin{figure}
    \centering
    \includegraphics[scale=0.3]{../paper/figs/embree_rf.png}
  \end{figure}
\end{columns}
\end{center}
\end{frame}
