...
\begin{frame}
  ...
  Fortunately, we can maintain this watertightness in our Embree representation of the mesh.
...
%      \node (t5) [mbelement, fill=red, above = 2cm of v5, xshift=-3cm] {\small t5};
      ...
      \node (sceneA) [auto,above = 0.25cm of t1] {Scene A};
...
%      \node (t5) [mbelement, fill=red, above = 2cm of v5, xshift=-3cm] {\small t5};
      ...
      \node (sceneB) [auto,above = 0.25cm of t5] {Scene B};
      ...
      \node (dot0) [circle, fill=blue,xshift=5cm,draw=black,minimum width=0.1cm] {};
      \node (dot1) [circle, fill=blue,xshift=6cm,yshift=0.5cm,draw=black,minimum width=0.1cm] {};
      \node (dot2) [circle, fill=blue,xshift=6cm,yshift=-0.5cm,draw=black,minimum width=0.1cm] {};
      ...
      \node (dot3) [circle, fill=blue,xshift=5cm,yshift=1cm,draw=black,minimum width=0.1cm] {};
      ...
      \node (dot4) [circle, fill=blue,xshift=6cm,yshift=1.5cm,draw=black,minimum width=0.1cm] {};
      ...
      \node (dot5) [circle, fill=blue,xshift=7cm,yshift=0.5cm,draw=black,minimum width=0.1cm] {};
...
\begin{tikzpicture}
  \node (moab rf)  [auto] {\includegraphics[scale=0.15]{moab_rf.png}};
  \node (emdag rf) [auto,xshift=6cm] {\includegraphics[scale=0.15]{embree_rf.png}};
  \pause
  \node at (moab rf.north) [ellipse,draw=red,yshift=-0.45cm,xshift=-2.2cm,minimum width=0.7cm,minimum height=0.4cm] {};
  \node at (emdag rf.north) [ellipse,draw=red,yshift=-0.45cm,xshift=-2.2cm,minimum width=0.7cm,minimum height=0.4cm] {};
