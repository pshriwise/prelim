...
\begin{center}
  \begin{tikzpicture}
    ...
    \visible<2,16>{\node (CAD L) [auto,outer sep=0pt,below = 0.1 cm of CAD] {\small geometric design};
      ...
      \node [auto,xshift= 1.2cm, below = 0.3cm of fng cad, outer sep = 0 pt] {FNG};
    }
    ...
    \visible<4>{\node (dot0) [circle,right = of PREPROC,fill=blue,draw=black,minimum width=0.1cm] {};
    ...
    \node (dot0) [right = of PREPROC,circle,fill=blue,xshift=5cm,draw=black,minimum width=0.1cm] {};
    \node (dot1) at (dot0) [circle, fill=blue,xshift=1.3cm,yshift=0.6cm,draw=black,minimum width=0.1cm] {};
    \node (dot2) at (dot0) [circle, fill=blue,xshift=1.5cm,yshift=-0.75cm,draw=black,minimum width=0.1cm] {};
    \draw[-,color=orange] (dot0) -- (dot1);
    \draw[-,color=orange] (dot0) -- (dot2);
...
\begin{center}
  \begin{tikzpicture}[scale=0.6, transform shape]
    \node (image) [yshift=-4cm] {\includegraphics[scale=0.65,trim={20 80 0 90},clip]{sealing_ex.png}};
