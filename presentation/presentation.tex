...
\begin{tikzpicture}
  ...
  \node (nst) [auto,below = 0.1cm of nsl] {(~5M Triangles)};
  \node (ncl) [auto,right = of nsl,xshift=1.75cm] {Nested Cubes};
  \node (nct) [auto,below = 0.1cm of ncl]{(36 triangles)};
...
\vfill
To improve single node performance, it may be time to start thinking about how ray traing for the purpose of Monte Carlo differs from the application of rendering.
\vfill
