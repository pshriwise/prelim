...
\begin{center}
  \begin{tikzpicture}
    ...
    \visible<2>{\node (CAD L) [auto,outer sep=0pt,below = 0.1 cm of CAD] {\small geometric design};
      \node [auto,below = 0.1cm of CAD L,outer sep=0pt] {\includegraphics[scale=0.07]{fng_cad.png}};}
    ...
    \visible<4>{\node (PREPROC LA) [auto,outer sep=0pt,above = 0.1cm of PREPROC] {\small surface faceting};
      ...
      \node [auto,below = 0.1cm of PREPROC LB,outer sep=0pt] {\includegraphics[scale=0.07]{fng_facets.png}};
    ...
    \pause %%%%
    \node [auto,below = 0.1cm of TOOLKIT L,outer sep=0pt] {\includegraphics[scale=0.07]{fng_usrbin22_Slice_z_TALLY_TAG.png}};
...
\begin{table}
  ...
  \begin{center}
    ...
    \begin{tabular}{lccc}
      ...
      \hline
      Sphere & 3.4E+05  & 3.9E+04  & 2.1E+05   \\
      Cube & 1.9E+05 & 9.4E+04 & 1.7E+05 \\
      Nested Spheres & 2.2E+05 & 1.9E+04 & 1.3E+05 \\
      Nested Cubes & 2.1E+05 & 1.0E+05 & 2.3E+05 \\
      \bottomrule
