...
Complex traversal schemes here.


\subsubsection{Bounding Volume Hierarchies (BVH)}%%Status: Done%%


More concrete intro to concept.
...
Figure from Intro to Ray Tracing here
...
The result of the SBVH is a hierarchy which can be traversed just like any other BVH. The general effect of the allowance for reference splitting during construction is more tightly fitting bounding volumes and reduced sibling node overlap. Their results consistently show significant improvement over other methods, ranging anywhere from (20-100\%).
